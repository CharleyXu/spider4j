...
public class CommentMapperProvider {
	...
	public String batchInsert(Map<String,Object> map){
		...
		sb.append("VALUES ");
		MessageFormat mf = new MessageFormat("(#'{'list[{0}].commentId},#'{'list[{0}].songId},#'{'list[{0}].nickname},#'{'list[{0}].linkedCount},#'{'list[{0}].content},#'{'list[{0}].time})");
	...
	public String batchUpdate(Map<String,Object> map){
		...
		sb.append("set content=case commentId");
