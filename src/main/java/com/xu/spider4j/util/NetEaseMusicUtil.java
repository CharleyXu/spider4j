...
public class NetEaseMusicUtil {
  ...
  public static String aesEncrypt(String src, String key, String iv) throws Exception {
    ...
    IvParameterSpec ivParameterSpec = new IvParameterSpec(iv.getBytes(Charsets.UTF_8));
  ...
  public static String parseMillisecone(long millisecond) {
    ...
    long yushu_minute = 0;
    try {
      yushu_day = millisecond % (1000 * 60 * 60 * 24);
      yushu_hour = (millisecond % (1000 * 60 * 60 * 24))
          % (1000 * 60 * 60);
      yushu_minute = millisecond % (1000 * 60 * 60 * 24)
          % (1000 * 60 * 60) % (1000 * 60);
      if (yushu_day == 0) {
